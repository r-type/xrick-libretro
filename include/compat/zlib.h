 ...
 */
    ...
    uLong  crc32_combine64 OF((uLong, uLong, z_off64_t));
#endif
...
#  endif
    ...
    z_off_t  gzseek OF((gzFile, z_off_t, int));
    z_off_t  gztell OF((gzFile));
    z_off_t  gzoffset OF((gzFile));
    uLong  adler32_combine OF((uLong, uLong, z_off_t));
    uLong  crc32_combine OF((uLong, uLong, z_off_t));
#endif
...
/* undocumented functions */
 ...
 int             deflateResetKeep OF((z_streamp));
